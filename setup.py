...
setup(
    ...
    author='TSFM team',  # Your name
    description='Time-Series Anomaly Detection Benchmark for Uncertainty Evaluation',  # A short description
    ...
    url='https://github.com/pleaseaddhyphens/tsfm-2026',  # Link to the repository or website
