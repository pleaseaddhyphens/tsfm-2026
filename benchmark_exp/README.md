...
* Develop your own algorithm: Run_Custom_Detector.py
    * Step 1: Implement custom AD class
    * Step 2: Implement model wrapper function `run_RandomDetector_Unsupervised` or `run_RandomDetector_Semisupervised`
    * Step 3: Specify hyperparameter dict
    * Step 4: Run the custom algorithm either `run_RandomDetector_Unsupervised` or `run_RandomDetector_Semisupervised`
